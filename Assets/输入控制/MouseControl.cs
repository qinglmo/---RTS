    ...
    private void HandleLeftClick()
    {
        ...
        if (hit.collider != null)
        {
            ...
            if (baseBuilding != null)
            {
                ...
                if(baseBuilding is IProduction productionBuilding)
                {
                    ListPanel.Instance.SetUnitPrefabList(productionBuilding.ProductionComponent_Building.ReadUnitList());
                    ListPanel.Instance.OnUnitPrefabSelected = productionBuilding.ProductionComponent_Building.GenerateUnit;
                    
                    ProductionQueuePanel.Instance.SetProduction(productionBuilding.ProductionComponent_Building);
                    ProductionQueuePanel.Instance.Show();
                }
            }
        ...
        else
        {
            ...
            ProductionQueuePanel.Instance.Hide();
        }
    }
